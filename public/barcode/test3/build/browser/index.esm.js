            ...
            window.RTCPeerConnection.prototype.removeTrack = function(sender) {
              ...
              if (sender)
                Object.keys(this._shimmedLocalStreams).forEach(function(streamId) {
                  ...
                  if (1 === _this9._shimmedLocalStreams[streamId].length) delete _this9._shimmedLocalStreams[streamId];
                });
        ...
        function(require, module, exports) {
          ...
          function shimConnectionState(window) {
            ...
            Object.defineProperty(proto, "connectionState", {
              get: function get() {
                return (
                  { completed: "connected", checking: "connecting" }[this.iceConnectionState] || this.iceConnectionState
                );
              },
              enumerable: true,
              configurable: true
          ...
          function shimCreateOfferLegacy(window) {
            ...
            window.RTCPeerConnection.prototype.createOffer = function(offerOptions) {
              if (offerOptions) {
                ...
                } else if (true === offerOptions.offerToReceiveAudio && !audioTransceiver) this.addTransceiver("audio");
                ...
                } else if (true === offerOptions.offerToReceiveVideo && !videoTransceiver) this.addTransceiver("video");
              }
          ...
          module.exports = function(window, edgeVersion) {
            ...
            RTCPeerConnection.prototype.setRemoteDescription = function(description) {
              ...
              sections.forEach(function(mediaSection, sdpMLineIndex) {
                ...
                var rejected =
                  SDPUtils.isRejected(mediaSection) && 0 === SDPUtils.matchPrefix(mediaSection, "a=bundle-only").length;
    ...
    },
    {
      ...
      value: function applyCameraSettings(cameraSettings) {
        ...
        if (null == this.activeCamera)
          return promise$1.reject(new CustomError({ name: "NoCameraAvailableError", message: "No camera available" }));
  ...
  createClass(BarcodePickerGui, [
    ...
    },
    {
      ...
      value: function isMirrorImageEnabled() {
        if (
          ...
          else return this.cameraManager.activeCamera.cameraType === Camera.Type.FRONT;
        } else return false;
      }
    },
    {
    ...
    },
    {
      ...
      value: function resizeCameraUploadIfNeeded() {
        ...
        this.cameraUploadProgressElement.style.transform = "scale(".concat(Math.min(1, width / 500, height / 300), ")");
      }
    },
    {
  ...
  function SymbologySettings() {
    ...
    this.checksums = new set$1(
      from_1$1(checksums).filter(function(c) {
        return c in SymbologySettings.Checksum || -1 !== values$1(SymbologySettings.Checksum).indexOf(c.toLowerCase());
      })
    );
  }
  ...
  createClass(ScanSettings, [
    ...
    },
    {
      ...
      value: function getSymbologySettings(symbology) {
        ...
        else if (symbology in Barcode.Symbology || -1 !== values$1(Barcode.Symbology).indexOf(symbology)) {
        ...
        if ("object" === _typeof_1(symbology)) {
          ...
          try {
            for (
              ...
              var s = _step.value;
              if (!(s in Barcode.Symbology || -1 !== values$1(Barcode.Symbology).indexOf(s)))
...
var BarcodePicker = (function() {
  function BarcodePicker$$1(originElement, _ref) {
    var _this = this;
    ...
    classCallCheck(this, BarcodePicker$$1);
    this.isReadyToWork = false;
...
function configure(licenseKey) {
  ...
  if (/^https?:\/\//.test(engineLocation)) scanditEngineLocation = "".concat(engineLocation);
  else {
