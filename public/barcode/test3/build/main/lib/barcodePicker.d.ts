...
export declare class BarcodePicker {
     ...
     */
    static create(originElement: HTMLElement, { visible, singleImageMode, playSoundOnScan, vibrateOnScan, scanningPaused, guiStyle, videoFit, scanner, scanSettings, enableCameraSwitcher, enableTorchToggle, enableTapToFocus, enablePinchToZoom, accessCamera, camera, cameraSettings, targetScanningFPS }?: {
        visible?: boolean;
        singleImageMode?: {
            desktop: {
                always: boolean;
