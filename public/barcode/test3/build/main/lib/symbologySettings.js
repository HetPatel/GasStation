...
var SymbologySettings = /** @class */ (function () {
    ...
    function SymbologySettings(_a) {
        ...
        this.extensions = new Set(Array.from(extensions).filter(function (e) {
            return (e in SymbologySettings.Extension || Object.values(SymbologySettings.Extension).indexOf(e.toLowerCase()) !== -1);
        }));
        this.checksums = new Set(Array.from(checksums).filter(function (c) {
            return (c in SymbologySettings.Checksum || Object.values(SymbologySettings.Checksum).indexOf(c.toLowerCase()) !== -1);
        }));
    }
    /**
    ...
    SymbologySettings.prototype.enableExtensions = function (extension) {
        ...
        if (typeof extension === "object") {
            this.extensions = new Set(tslib_1.__spread(this.extensions, Array.from(extension).filter(function (e) {
                return (e in SymbologySettings.Extension ||
