...
var ScanSettings = /** @class */ (function () {
    ...
    ScanSettings.prototype.getSymbologySettings = function (symbology) {
        if (this.symbologySettings.has(symbology)) {
            ...
            if (symbology in barcode_1.Barcode.Symbology || Object.values(barcode_1.Barcode.Symbology).indexOf(symbology) !== -1) {
    ...
    /**
     * @returns Whether GPU acceleration is configured to be enabled ot not. Note that this refers to the settings:
     * depending on browser capabilities the actual GPU usage might be prevented.
     */
        ...
        if (typeof symbology === "object") {
            try {
                for (var symbology_1 = tslib_1.__values(symbology), symbology_1_1 = symbology_1.next(); !symbology_1_1.done; symbology_1_1 = symbology_1.next()) {
                    ...
                    if (!(s in barcode_1.Barcode.Symbology || Object.values(barcode_1.Barcode.Symbology).indexOf(s) !== -1)) {
